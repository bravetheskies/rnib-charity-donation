...
${errorInfo.componentStack}`);
  ...
  function Extension() {
    ...
    const defaultDonationOptions = [
      ...
      { label: "\xA310", value: "10" }
    ];
    const donationOptions = donation_amount ? donation_amount.split(",").map((amount) => ({
      label: `\xA3${amount.trim()}`,
      value: amount.trim()
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { spacing: "base", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockStack2, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
        Checkbox2,
        {
          id: "giftAid",
          name: "giftAid",
          ...
          children: [
            "I want to",
            " ",
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Link2, { to: giftlink, children: "Gift Aid" }),
            " ",
